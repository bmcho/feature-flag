...
import com.bmcho.featureflagadapter.cache.MyCache;
...
import static dev.openfeature.contrib.providers.flagd.resolver.common.Convert.*;
...
public final class RpcResolver implements Resolver {
     ...
     */
    public RpcResolver(
        final FlagdOptions options, final MyCache cache, final Consumer<FlagdProviderEvent> onProviderEvent) {
        this.cache = cache;
